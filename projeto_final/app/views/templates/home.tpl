...
<body>
    ...
    <nav>
        <div class="nav-container">
            ...
            <ul class="nav-links">
                ...
                <li><a href="#download" class="nav-cta">Baixar App</a></li>
            </ul>
        ...
        <section class="pricing" id="pricing">
            ...
            <div class="pricing-cards">
                <div class="pricing-card">
                    ...
                    <button class="plan-btn secondary">Começar Agora</button>
                </div>
                ...
                <div class="pricing-card featured">
                    ...
                    <button class="plan-btn primary">Teste 7 dias grátis</button>
                </div>
                ...
                <div class="pricing-card">
                    ...
                    <button class="plan-btn secondary">Escolher Plano</button>
                </div>
            </div>
        </section>
            ...
            <div class="download-content">
                ...
                <div class="download-buttons">
                    <a href="#" class="store-btn">
                        <img src="data:image/svg+xml;base64," alt="App Store">
                    </a>
                    <a href="#" class="store-btn">
                        <img src="data:image/svg+xml;base64," alt="Google Play">
                    </a>
                </div>
                <div class="qr-code">
    ...
    <footer>
        <div class="footer-content">
            <p>Feito por Ana Luisa UnB-2025.1 232000660</p>
