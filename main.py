...
# Adicionar o diretório zen_mind_project ao path
project_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'zen_mind_project')
...
if __name__ == '__main__':
    try:
        ...
        print("   pip install -r zen_mind_project/requirements.txt")
        sys.exit(1)
